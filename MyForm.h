...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->toolStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(22) {
				this->openToolStripButton,
					this->newToolStripButton, this->saveToolStripButton, this->toolStripSeparator5, this->printToolStripButton, this->toolStripSeparator,
					...
					this->toolStripSeparator1, this->toolStripButton3, this->toolStripButton1, this->toolStripButton2, this->toolStripSeparator3,
					this->toolStripButton4, this->toolStripButton5, this->toolStripButton6, this->toolStripSeparator4, this->toolStripButton7, this->toolStripButton8
			});
			...
			this->toolStripButton1->Text = L"Âèğ³âşâàííÿ ïî öåíòğó";
			...
			this->toolStripButton2->Text = L"Âèğ³âíşâàííÿ ç ë³âîãî áîêó ";
			...
			this->toolStripButton4->Text = L"Íàï³âæğíèé";
			...
			this->richTextBox1->Size = System::Drawing::Size(957, 475);
			...
			this->statusStrip1->Size = System::Drawing::Size(957, 22);
			...
			this->ôàéëToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->ñòâîğèòèToolStripMenuItem,
					this->â³äêğèòèToolStripMenuItem, this->çáåğåãòèßêToolStripMenuItem, this->çáåğåãòèToolStripMenuItem, this->äğóêToolStripMenuItem
			});
			...
			this->ñòâîğèòèToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::pasteToolStripButton_Click);
			// 
			...
			this->â³äêğèòèToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::openToolStripButton_Click);
			// 
			...
			this->çáåğåãòèToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::saveToolStripButton_Click);
			// 
			...
			this->ïğàâêàToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->êîï³şâàòèToolStripMenuItem,
					this->âñòàâèòèToolStripMenuItem, this->âèğ³çàòèToolStripMenuItem
			});
			...
			this->êîï³şâàòèToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::copyToolStripButton_Click);
			// 
			...
			this->âèğ³çàòèToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::cutToolStripButton_Click);
			// 
			...
			this->æîâòèéToolStripMenuItem->Size = System::Drawing::Size(224, 26);
...
#pragma endregion
	...
	private: System::Void ïàíåëü²íñòğóìåíò³âToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		toolStrip1->Visible = !(statusStrip1->Visible);
	}
